...
extension NWParameters {
	...
	// Create parameters for use in YMLNWConnection and YMLNWListener.
	convenience init(passcode: String) {
		...
		let peerOptions = NWProtocolFramer.Options(definition: YMLNWProtocol.definition)
		self.defaultProtocolStack.applicationProtocols.insert(peerOptions, at: 0)
	}
